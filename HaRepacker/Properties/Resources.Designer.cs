...
namespace HaRepacker.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 Animated Portable Network Graphics (*.png) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 MapleFire 的本地化字符串。
        /// </summary>
        internal static string EncTypeMapleFire {
            get {
                return ResourceManager.GetString("EncTypeMapleFire", resourceCulture);
            }
        }
        
        /// <summary>
        ///   查找类似 MSEA (old) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Please enter valid input 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Input was invalid.
        ///Please provide valid values before confirming. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The {0} was invalid.
        ///Please make sure all values are valid before confirming. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 portal type value 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Images (*.jpg;*.bmp;*.png;*.gif;*.tiff) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 This item is not an animation. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Cannot insert selected object into this type of wz node. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to abort the current operation? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to remove this node? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Could not open WZ file &quot;{0}&quot; 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Help could not be shown because the help file ({0}) was not found 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The file &quot;{0}&quot; is invalid and will be skipped. Error: {1} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The file at {0} is a List.wz file and will be skipped. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to reload all files? 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Please select the WZ file to save 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Are you sure you want to unload all files? 的本地化字符串。
        /// </summary>
        ...
        ///   查找类似 {0}
        ///
        ///Click &quot;Yes&quot; to download the new version. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 MPEG-1 Audio Layer 3 (*.mp3) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Indent must be above 0 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Could not load settings file, make sure it is not in use. If it is not, delete it and try again. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Version must be above 0 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select default XML folder 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select where to save the animation 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the output directory 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select where to save the file 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select where to save the XML 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the WZ File 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the IMG files 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Select the XML files 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 WZ Image Files (*.img) 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 eXtended Markup Language (*.xml) 的本地化字符串。
        /// </summary>
