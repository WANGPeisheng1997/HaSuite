...
namespace HaCryption
{
    class Program
    {
        ...
        {
            string source_folder = "F:\\GitHub\\MapleFire083Client\\Data";
            string dest_folder = "D:\\冒险岛私服\\MapleFire-Ver0.2.2\\Data";

            totalImgCount = ImgCount(source_folder);

            Transform_IMG_Folder_Encoding(source_folder, dest_folder, CryptoConstants.WZ_GMSIV, CryptoConstants.WZ_MapleFireIV);
        }
    }
}
